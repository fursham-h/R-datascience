...
<p align="center">
  <img src="1620376325317.jpg" width="450"/>
</p>
...
manger or (2) installing binaries from command-line.  
...
For users having issues installing miniconda3 or the other softwares using miniconda3
package manager, please refer to [alternative section]() below to install
these softwares using
...
Terminal or Command Prompt and type the following in the console:
